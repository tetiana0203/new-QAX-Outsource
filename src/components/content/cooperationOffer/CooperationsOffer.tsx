    ...
    return (
        <div className="cooperation-offer" id="cooperation-offer">
            <div className="container">
                <h2 className="cooperation-offer__title">Cooperation Offer</h2>
                <p className="cooperation-offer__description">QAX company suggests you three main cooperation options</p>

                <div className="cooperation-offer__info">
                    <h3 className="cooperation-offer__subtitle">Fixed Price</h3>
                    <div className="cooperation-offer__content">
                        <p className="cooperation-offer__text">With this approach we define with you a project testing scope, discuss all specifications, testing environments and other details. Then we agree project verification cost and deadline. The option will be more suitable for you, if there is no big amount of objects to test at current project stage.</p>
                        <h4 className="cooperation-offer__text">Advantages</h4>
                        <ul>
                ...
                <div className="cooperation-offer__info">
                    <h3 className="cooperation-offer__subtitle">Outstaff </h3>
                    <div className="cooperation-offer__content">
                        <p className="cooperation-offer__text">If you have few projects or / and long terms cooperation plans with our company, then we can provide you a QA team (including QA Team lead , if needed). With this model, we assign QA sources, based on your requirements. In future, you can change number of QA(s), depending of test load.</p>
                        <h4 className="cooperation-offer__text">Advantages</h4>
                        <ul>
